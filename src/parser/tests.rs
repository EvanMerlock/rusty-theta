...
define_parse_test!(basic_parser_recog_bool, BINARY_TEST_2, AbstractTree::new(Expression::Binary { left: Box::new(Expression::Literal(LITERAL_LEFT_3)), operator: LITERAL_BINARY_3, right: Box::new(Expression::Literal(LITERAL_RIGHT_3)) }));
